...
```sh
gh pr create -R diegocevallos-tech/censo-vivo-ecuador --base main --head feat/fase-1b3-tiles-paquete-web --title "feat: publicar cartografía y paquete web de fase 1B-3" --body-file docs/fase1b3_report.md
```

Hacer commit y push de esta documentación y abrir PR 1B-3. Mantener el PR abierto para revisión. Después seguir 2A y 2B en ramas separadas según la autorización vigente sin tocar la auditoría independiente.
