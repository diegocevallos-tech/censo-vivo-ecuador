...
- Si a zoom de manzana no hay ninguna manzana visible y los tiles ya cargaron, el visor presenta sectores censales como unidad disponible. Se comprobó en un sector rural de Morona Santiago sin manzanas cartografiadas.
...
| Sector rural sin manzanas visibles, zoom 14,3 | Fallback a sector y clic `exacto`; 0 errores JavaScript |
...
- En vistas mixtas con alguna manzana visible, el zoom sigue en escala de manzana; el fallback sectorial se activa cuando no hay ninguna en la vista.
